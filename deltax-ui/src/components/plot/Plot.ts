...
export class Plot {
    ...
    constructor(
        ...
        this.options.series[0].value = (u: uPlot, _rv: number, sidx: number, idx: number) => this.getTime(u, sidx, idx);
        this.spark = spark;
        this.slice = slice;
    ...
    private getTime(_u: uPlot, _sidx: number, idx: number) {
    ...
    */
    ...
    private getValue(_u: uPlot, sidx: number, idx: number) {
    ...
    public addSerie(name: string, scale = "y", options = {} as uPlot.Series & { isString?: boolean, color?: string, scaleOption?: uPlot.Scale }) {
        ...
        if (extraOptions.isString) {
            this.options.series.push({
                ...
                value: (u: uPlot, _rv: number, sidx: number, idx: number) => this.getValue(u, sidx, idx),
